---
name: exposure-protection-pak
description: "OHS Exposure Protection Pak — Immune support specifically for current pandemic"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/exposure-protection-pak`.
...
| **Price** | $84.00 |
| **Variant SKU** | `850019587470` |
| **Container** | Packets · qty 31 · 31 servings |
| **Dose** | ‍Therapeutic: Take 1 packet three times daily with meals for 10 days. Protection: Take 1 packet per day. |
| **Fact card** | exposure-protection-pak-fact-card |
...
- Zinc
- Nitrates
- Exposure Protection Pak Probiotics
- Curcumin

### FAQs (from the product page)
how-do-you-guarantee-potency; where-is-the-expiration-date-on-the-product; im-concerned-about-the-vaccine-are-there-any-vitamins-that-can-help-if-i-get-it; are-there-vitamins-that-help-protect-my-body-from-getting-covid; what-if-i-get-covid-are-there-vitamins-that-can-help

### Tags (Shopify)
`Bulk Discountable`, `Direct Script`, `HP Line Order`, `Tier 1 - Retail`, `Visibility - All`
