---
name: optimal-complete-performance-bulk-container-chocolate
description: "OHS Optimal Complete Performance - Exotic Chocolate — Balanced protein powder"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/optimal-complete-performance-bulk-container-chocolate`.
...
| **Price** | $90.00 |
| **Variant SKU** | `850019587289` |
| **Container** | Grams · qty 1500 · 30 servings |
| **Dose** | Take 2 level scoops with 12-16 oz. of water or other healthy liquid. Mix thoroughly and drink. |
| **Fact card** | optimal-complete-performance-vanillachocolate-fact-cards |
...
### Tags (Shopify)
`Bulk Discountable`, `Direct Script`, `HP Line Order`, `Powder`, `Standard Size`, `Tier 2 - Retail`, `TruShield`, `Visibility - All`
