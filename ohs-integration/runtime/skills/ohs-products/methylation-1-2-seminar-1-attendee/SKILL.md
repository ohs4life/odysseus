---
name: methylation-1-2-seminar-1-attendee
description: "OHS Methylation 1 & 2 Seminar - 1 Attendee — Seminar"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/methylation-1-2-seminar-1-attendee`.
...
Methylation Series  1 & 2, a certification seminar offered by Dr. Marc Harris ND for health professionals. You will receive a test kit for SNPs, along with his nutrient and nutrition recommendations to remedy those genetic SNPs to help your patients move closer to optimal health.

### Tags (Shopify)
`Exclude Recommended`, `Exclude Review`, `exclude_rebuy`, `Visibility - Admin Only`
