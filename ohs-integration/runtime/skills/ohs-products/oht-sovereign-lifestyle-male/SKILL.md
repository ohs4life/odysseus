---
name: oht-sovereign-lifestyle-male
description: "OHS OHT For Males - Sovereign Lifestyle — One-on-one online health coaching"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/oht-sovereign-lifestyle-male`.
...
### Full description
One-on-one online health coaching. Including tailored meal plans & workouts with weekly accountability and goal-setting calls.

### Tags (Shopify)
`AlternativeCommission`, `Direct Script`, `Exclude Recommended`, `Exclude Review`, `exclude_rebuy`, `Visibility - All`
