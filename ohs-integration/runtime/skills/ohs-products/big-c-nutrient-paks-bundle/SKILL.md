---
name: big-c-nutrient-paks-bundle
description: "OHS Big C Nutrient Paks Bundle — Nutritional support for cancer and other serious conditions"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/big-c-nutrient-paks-bundle`.
...
| **Price** | $255.00 |
| **Variant SKU** | `850019587340` |
| **Container** | qty 60 · 60 servings |
| **Dose** | Take 1 packet from each of the three Paks twice daily with food. |
...
- Omega 3S Big C Paks
- Therapeutic Mushroom Blend Big C Paks
- Resveratrol Big C Paks
- Potent Phytonutrient Blend Big C Paks
- Ubiquinol
- Opti Pqq

### FAQs (from the product page)
what-is-the-condition-protocol-for-this-product; how-do-i-take-these-big-c-paks

### Tags (Shopify)
`Direct Script`, `exclude_rebuy`, `HP Line Order`, `Tier 2 - Retail`, `Visibility - All`
