---
name: opti-adrenal
description: "OHS Opti-Adrenal — Nutritionally supports healthy adrenal glands"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/opti-adrenal`.
...
| **Price** | $39.00 |
| **Variant SKU** | `645871744006` |
| **Container** | Capsules · qty 90 · 45 servings |
| **Dose** | Take 2 capsules daily, once in the morning, and once in the evening. |
| **Fact card** | opti-adrenal-fact-cards |
...
### Tags (Shopify)
`Best Seller`, `Bottle`, `Brimhall Opti`, `Bulk Discountable`, `Direct Script`, `HP Line Order`, `Standard Size`, `Tier 1 - Retail`, `Visibility - All`
