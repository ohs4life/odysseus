---
name: chemzyme
description: "OHS Optimal Chemzyme — Detoxification of phthalates"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/chemzyme`.
...
| **Price** | $39.00 |
| **Variant SKU** | `850019587661` |
| **Container** | Capsules · qty 60 · 30 servings |
| **Dose** | Take 2 capsules daily on an empty stomach, 1 mid-morning and 1 afternoon, or as directed. |
...
The Ultimate Enzyme Formula for Modern Life

Chemzyme is a revolutionary formula developed to address the alarming increase in food additives and harmful chemicals, particularly phthalates, found in the modern diet. As food processing has intensified, so has the presence of these toxic substances, turning many so-called healthy foods into potential health hazards. Chemzyme helps to detoxify these harmful compounds, allowing your body to fully benefit from the nutrition you eat.

### FAQs (from the product page)
is-chemzyme-safe-for-pregnancy

### Tags (Shopify)
`Bottle`, `Direct Script`, `Tier 1 - Retail`, `Visibility - All`
