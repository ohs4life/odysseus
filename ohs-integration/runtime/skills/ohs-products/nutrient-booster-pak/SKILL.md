---
name: nutrient-booster-pak
description: "OHS Semaglutide Nutrient Bundle — Shelf Pak (pre-built daily nutrient pak)"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/nutrient-booster-pak`.
...
| **Price** | $390.00 |
| **Variant SKU** | `9009821` |
| **Container** | Bundle · qty 60 · 60 servings |

### Tags (Shopify)
`Bulk Discountable`, `Direct Script`, `exclude_rebuy`, `HP Line Order`, `Visibility - All`
