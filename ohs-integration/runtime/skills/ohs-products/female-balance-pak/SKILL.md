---
name: female-balance-pak
description: "OHS Optimal Female Balance Pak — Regain hormonal harmony by balancing estrogen and testosterone"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/female-balance-pak`.
...
### Tags (Shopify)
`Bulk Discountable`, `Direct Script`, `Tier 1 - Retail`, `Visibility - All`
