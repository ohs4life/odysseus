---
name: optimal-fiber-glp-1
description: "OHS Optimal Fiber GLP-1 — Support blood sugar regulation"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/optimal-fiber-glp-1`.
...
| **Price** | $40.00 |
| **Variant SKU** | `850019587760` |
| **Container** | Grams · qty 195 · 62 servings |
| **Dose** | Mix 1 level scoop into 8 ounces water or beverage of your choice,  twice daily or as recommended by a Health Care Provider. |
...
will-this-make-me-constipated

### Tags (Shopify)
`Direct Script`, `Powder`, `Tier 2 - Retail`, `Visibility - All`
