...
description: "OHS Big C Nutrient Pak #1 — Shelf Pak (pre-built daily nutrient pak)"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/big-c-nutrient-pak-1`.
