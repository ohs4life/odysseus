---
name: drg-pro-health-pak
description: "OHS PL - DRG Pro-Health Pak — Private Label"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/drg-pro-health-pak`.
...
| **Price** | $41.80 |
| **Variant SKU** | `850019587845` |

### Tags (Shopify)
`Exclude Recommended`, `Exclude Review`, `exclude_rebuy`, `PL - DRG`, `Private Label`, `Visibility - Admin Only`
