---
name: custom-health-pak-60-pks-2-capsules-zyto
description: "OHS Zyto Custom Health Pak (60 pks - 2 capsules) — Zyto"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/custom-health-pak-60-pks-2-capsules-zyto`.
...
| **Product type** | Zyto |
| **Price** | $103.00 |
| **Variant SKU** | `105-zyto-2` |

### Tags (Shopify)
`Exclude Recommended`, `Exclude Review`, `exclude_rebuy`, `Visibility - Admin Only`, `Zyto`
