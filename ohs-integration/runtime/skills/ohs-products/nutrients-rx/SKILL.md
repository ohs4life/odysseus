---
name: nutrients-rx
description: "OHS Nutrients Rx Lab Work — Complete nutrient blood & lab panel"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/nutrients-rx`.
...
i-have-purchased-nutrient-rx-what-do-i-do-next; what-do-you-do-with-my-test-results; how-often-do-i-need-to-retest-my-n-rx

### Tags (Shopify)
`Direct Script`, `Exclude Recommended`, `exclude_rebuy`, `Includes Lab Work`, `smart-cart-hide-qty`, `Visibility - All`
