---
name: digest-a-meal-pouch
description: "OHS $1 Digest-A-Meal Offer — Product"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/digest-a-meal-pouch`.
...
| **Price** | $34.00 |
| **Variant SKU** | `9283746515` |
| **Dose** | Take 1-2 capsules with each meal/snack |

### Tags (Shopify)
`Bottle`, `Direct Script`, `Els PW 30546`, `Exclude Recommended`, `Exclude Review`, `exclude_rebuy`, `smart-cart-hide-qty`, `Visibility - All`
