---
name: essential-glutathione
description: "OHS Essential Glutathione — Now with electrolytes!"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/essential-glutathione`.
...
| **Price** | $37.00 |
| **Variant SKU** | `850019587104` |
| **Container** | Wafers · qty 20 · 20 servings |
| **Dose** | Take 1 effervescent wafer dissolved in water 1-2 times daily or as prescribed by a health professional |
| **Fact card** | essential-glutathione-fact-cards |
...
Glutathione (gloo-tah-thai-own) a tripeptide comprised of the amino acids glutamate, cysteine and glycine. It is a naturally occurring protein made by and used by every cell in the body. It also contains a sulfur molecule, which plays a major role in its antioxidant and detoxification functions. It’s something your body produces less and less of as you age.

As an antioxidant, glutathione protects cells against the oxidative stress that damages cell membrane proteins. Without adequate glutathione, mitochondrial oxygen metabolism produces large numbers of free radicals, which causes cells to perform poorly or die. A number of studies have shown that oxidative stress increases with aging, and leads to degenerative diseases, like heart disease, cancer, diabetes, and more. Supplementing with organic glutathione has been shown to:
 ...
 • Aid in fighting autoimmune diseases

 • Reduce inflammation

 
 Glutathione is considered the most important antioxidant because it is the only one capable of working with enzymes. One enzyme, glutathione peroxidase (GPx), works with glutathione to prevent cell membranes from becoming oxidized, which would otherwise lead to cell death. Glutathione and vitamin C work interactively to quench free radicals. Essential Glutathione combines the absorbable tri-peptide form of glutathione with vitamin C in an effervescent wafer, making it the most potent, highly effective glutathione available.
...
The chronic inflammation caused by autoimmune diseases can increase oxidative stress. These diseases include rheumatoid arthritis, celiac disease, and lupus. According to one study on the effects glutathione has on immunity, glutathione helped reduce oxidative stress by either stimulating or reducing the body’s immunological response.
...
There are over 100,000 glutathione citations on PubMed, and research continues worldwide. Interest in this molecule has extended into the general public consciousness. It’s been called both the Superhero of Antioxidants, the Great Protector, and the Mother of Antioxidants.
...
OHS has always known the importance of glutathione and how critical it is to increase amounts in the body. But the research has been very clear that taking glutathione orally has been unsuccessful and possibly even dangerous because you are putting a protein in the body that if not accepted could be looked at as an invader.

Our glutathione is made up of 3 amino acids, glutamine, cysteine and glycine. We’ve solved the potential health dangers by creating a phenomenal absorption by using tri-peptide glutathione in a special citrus carrier and effervescent delivery system. This breakthrough transforms the glutathione supplement industry providing high dose glutathione delivered safely to the cellular level.

Pairing Essential Glutathione with the Optimal Fruit & Veggie Plus powder is--in our opinion--the most potently powerful antioxidant blitz a person can take to load the body with powerful health-promoting antioxidants.
...
### Tags (Shopify)
`Bottle`, `Bulk Discountable`, `Direct Script`, `Harris Essential`, `HP Line Order`, `Standard Size`, `Tier 1 - Retail`, `TruShield`, `Visibility - All`
