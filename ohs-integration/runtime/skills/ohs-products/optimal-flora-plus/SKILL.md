...
description: "OHS Optimal Flora Plus — Helps avoid upset stomachs, fatigue, frequent colds/flu, and dairy sensitivity"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/optimal-flora-plus`.
...
| **Price** | $35.00 |
| **Variant SKU** | `655705123075` |
| **Container** | Capsules · qty 90 · 30 servings |
| **Dose** | Take 3 capsules daily, one with each meal or as directed. |
| **Fact card** | optimal-flora-plus-fact-cards |
...
- Flora Plus Patented Probiotics
- Jerusalem Artichoke
- Opti Blend Delivery System

### FAQs (from the product page)
how-do-you-guarantee-potency; where-is-the-expiration-date-on-the-product; what-is-the-difference-between-flora-plus-and-flora-blitz; how-long-do-i-need-to-take-flora-plus; why-must-we-take-probiotics-all-the-time; ive-heard-probiotics-must-be-refrigerated-and-cannot-get-hot-does-flora-have-to-be-refrigerated-or-stay-out-of-the-heat-also; how-does-flora-help-with-weight-reduction; is-it-safe-to-take-other-medication-while-taking-flora; what-is-the-difference-between-probiotics-and-antibiotics

### Tags (Shopify)
`Best Seller`, `Bottle`, `Bulk Discountable`, `Direct Script`, `HP Line Order`, `Standard Size`, `Tier 1 - Retail`, `Visibility - All`
