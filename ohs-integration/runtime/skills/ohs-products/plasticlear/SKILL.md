---
name: plasticlear
description: "OHS PlastiClear Bundle — Targets plastics with precision—see your before/after results"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/plasticlear`.
...
| **Product type** | Bundle |
| **Price** | $465.00 |
| **Variant SKU** | `9283746560` |

### What it's for
- Targets plastics with precision—see your before/after results
- Scientifically backed detox for plastic-related toxins
- Includes the world’s first microplastic blood test
- Combats inflammation, fatigue, and gut/hormonal imbalance

### Full description
Plastic contamination isn’t a fringe concern anymore—it’s a worldwide epidemic backed by dozens of studies. Plastic particles, especially phthalates and associated chemicals like PFAS, are found in nearly every human tested. They bypass the body’s natural defenses and accumulate in fat, organs, even the brain. And they don’t leave on their own.

That’s why we created the PlastiClear bundle. The Plastic Detox Pak uses science-backed and natural ingredients to help your body recognize, bind, and remove these toxic particles. Key ingredients like Chemzyme (with plastic-digesting Phthalazyme), Resveratrol, and Opti-GI provide liver, gut, and immune support—all while eliminating phthalates through natural detox channels.

But true detox begins with knowledge. The PlasticTest lets you see your personal exposure in black and white. Most people are shocked by their results, and that awareness creates real motivation for change. Once your 90-day protocol is complete, you can retest to track your progress and see your efforts paying off.

This is the future of detox—no more guessing, no more generic protocols. Just real data, real action, and real results.

### Key ingredients (Shopify metafield)
- Plastic Test All Inclusive Microplastics Testing Kit
- 3 Plastic Detox Paks

### FAQs (from the product page)
how-do-i-use-this-bundle; is-this-bundle-safe-for-everyone; how-effective-is-chemzyme-at-removing-phthalates; can-i-share-the-test-with-someone-else; how-often-should-i-retest; what-do-you-do-with-my-test-results

### Tags (Shopify)
`AlternativeCommission`, `Direct Script`, `Els PW 30031`, `Els PW 30031:49902101954862`, `Exclude Recommended`, `Exclude Review`, `exclude_rebuy`, `Includes Lab Work`, `smart-cart-hide-qty`, `Visibility - All`
