---
name: optimal-1-digest-a-meal
description: "OHS Optimal 1 Digest-A-Meal — Helps break down all nutrients"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/optimal-1-digest-a-meal`.
...
| **Price** | $36.00 |
| **Variant SKU** | `655705123013` |
| **Container** | Capsules · qty 90 · 45 servings |
| **Dose** | Take 1-2 capsules before each meal or as needed. |
| **Fact card** | optimal-1-digestion-fact-cards |
