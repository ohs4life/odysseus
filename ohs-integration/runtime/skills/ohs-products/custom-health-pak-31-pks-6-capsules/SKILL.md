---
name: custom-health-pak-31-pks-6-capsules
description: "OHS Custom Health Pak (31 pks - 6 capsules) — Custom Health Pak (built from your lab results — see Nutrients Rx)"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/custom-health-pak-31-pks-6-capsules`.
...
| | |
|---|---|
| **Product type** | Custom Health Pak (built from your lab results — see Nutrients Rx) |
| **Price** | $86.00 |
| **Variant SKU** | `309` |

### Tags (Shopify)
`Exclude Recommended`, `Exclude Review`, `exclude_rebuy`, `OHS Custom Pak`, `Tier 2 - Retail`, `Visibility - Admin Only`

> **Custom Health Pak** — this is the output of the Nutrients Rx program. It is **created only after the customer places the order** (after lab results are posted). See `ohs-lab-testing/nutrients-rx-customer-journey` for the full customer journey.
