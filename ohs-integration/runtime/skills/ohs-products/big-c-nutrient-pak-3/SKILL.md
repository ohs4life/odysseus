---
name: big-c-nutrient-pak-3
description: "OHS Big C Nutrient Pak #3 — Shelf Pak (pre-built daily nutrient pak)"
version: 1.0.0
...
## Verification
- The OHS store URL for this product is `optimalhealthsystems.com/products/big-c-nutrient-pak-3`.
...
| **Price** | $110.00 |
| **Variant SKU** | `850019587333` |
| **Container** | Packets · qty 60 · 60 servings |

### Tags (Shopify)
`Bulk Discountable`, `Exclude Recommended`, `exclude_rebuy`, `Tier 1 - Retail`, `Visibility - Admin Only`
